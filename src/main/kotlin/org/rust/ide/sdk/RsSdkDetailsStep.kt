...
class RsSdkDetailsStep(
    ...
    private fun optionSelected(selectedValue: String?) {
        ...
        if (ADD == selectedValue) {
            RsAddSdkDialog.show(project, module, existingSdks.toList(), sdkAddedCallback)
        } else {
            showAll?.show()
        }
    }
    ...
    companion object {
        ...
        fun show(
            ...
            val sdkHomesStep = RsSdkDetailsStep(project, module, showAllDialog, existingSdks, sdkAddedCallback)
